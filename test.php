...
<section>
		...
		?>
				...
				$requete_commentaire = $bdd->prepare('SELECT *FROM post
				...
				WHERE id_acteur = ?
				ORDER BY date_add	DESC'); // Filtre sur les commentaires associés à l'acteur consulté et classement par date d'ajout, du plus récent au plus ancien$requete_commentaire->

				execute(array($_GET['id_acteur']));
