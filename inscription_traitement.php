...
else
{
		if($_POST['mot_de_passe'] == $_POST['confirmation_mot_de_passe'])
		{
				...
				$req = $bdd->prepare('INSERT INTO account(prenom, nom, nom_utilisateur, mot_de_passe, question, reponse) VALUES(:prenom_utilisateur, :nom_utilisateur, :pseudo_utilisateur, :mot_de_passe, :question, :reponse)');$req->
				execute(array(
