...
$req->execute(array(
    'nouveau_prenom_utilisateur' => htmlspecialchars($_POST['nouveau_prenom_utilisateur']),
    'nouveau_nom_utilisateur' => htmlspecialchars($_POST['nouveau_nom_utilisateur']),
    'nouveau_pseudo_utilisateur' => htmlspecialchars($_POST['nouveau_pseudo_utilisateur']),
